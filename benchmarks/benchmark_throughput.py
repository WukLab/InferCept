...
def run_vllm(
    ...
    print(f"total num tokens: {llm.llm_engine.scheduler.total_tks}")
    return end - start
...
def main(args: argparse.Namespace):
    ...
    if args.backend == "vllm":
        elapsed_time = run_vllm(requests, args.model, args.tokenizer,
                                ...
                                args.trust_remote_code, args.dtype, args.chunk_fill, args.load_format)
...
if __name__ == "__main__":
    ...
    parser.add_argument('--chunk-fill',
                        action='store_true')
    parser.add_argument('--skip-some',
                        type=int,
                        default=100,
                        help='skip some preceeding requests to populate the system')
