...
class EngineArgs:
    ...
    def add_cli_args(
        ...
        # NOTE(zijian): deprecated, use deepspeed kernel to decide the block size
        # KV cache arguments
        ...
        parser.add_argument('--api-policy',
                            type=str,
                            choices=['D', 'P', 'S', 'H', 'V', 'T', 'W', 'G', 'H-S', 'H-D', 'H-B'],
                            help='D=Discard, P=Preserve, S=Swap+passive, H=Heuristic, V=Vulcan, T=Test, W=Waste, G=Greedy',
